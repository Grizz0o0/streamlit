...
default_selected_genres = ['Action', 'Comedy']
selected_genres = st.sidebar.multiselect("Choose Genre:", genres, default_selected_genres)
...
with left_column:
    ...
    st.table(filtered_data[['name', 'genre', 'year']].head(10))
